...
from .robocon2026_marl_env_cfg import Robocon2026MarlEnvCfg


class Robocon2026MarlEnv(DirectMARLEnv):
    cfg: Robocon2026MarlEnvCfg

    def __init__(self, cfg: Robocon2026MarlEnvCfg, render_mode: str | None = None, **kwargs):
